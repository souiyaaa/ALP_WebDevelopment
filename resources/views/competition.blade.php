        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            @foreach($categories as $category)
                <div class="p-5 bg-white rounded-lg shadow-md text-center transition-transform transform hover:scale-105">
                    ...
                    <div>
                        <button 
                        @click="open = true; selectedCategory = '{{ $category->category_name }}'" 
    ...
    @endif
        ...
        <div 
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 w-11/12 max-w-lg">
                <h3 class="text-2xl font-bold mb-4">Category Details</h3>
                <h2 class="text-m mb-3">{{ $category->category_desc }}</h2>
